...
export default function Sidebar({ user, isOpen, onClose }: SidebarProps) {
  ...
  const navItems = [
    { href: '/sga/dashboard', label: '🏠 Dashboard', icon: '🏠' },
    { href: '/sga/dashboard/requests', label: '📋 Content Requests', icon: '📋' },
    { href: '/sga/dashboard/calendar', label: '📅 Calendar', icon: '📅' },
    { href: '/sga/dashboard/team', label: '👥 Team', icon: '👥' },
    { href: '/sga/dashboard/ideas', label: '💡 Ideas Bank', icon: '💡' },
    { href: '/sga/dashboard/analytics', label: '📊 Analytics', icon: '📊' },
  ]
    ...
    <>
      ...
      >
        ...
        <div className="border-t border-slate-800 p-4 space-y-3">
          <div className="px-4 py-2 bg-slate-800 rounded text-sm">
